...
<html>
    <head>
        ...
        <title>Teachers Manipulate Form</title>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-9">
      ...
      <div id="section2"> 
        <form:form method = "Post" action="${action}" commandName="teachers">
  ...
  <div class="form-group">
    ...
    <form:input type="text" path="degree" class="form-control" id="education" />
  </div>
  <div class="form-group">
    <label for="dept">Department:</label>
    <form:input type="text" path="department" class="form-control" id="debt" />
  </div>
  <button type="submit" value="Save" class="btn btn-default">Submit</button>
      ...
      <div id="section42">         
        ...
        <div><a href="<c:url value='/teachers/teacher_manipulate' />">Add teacher form</a></div>
    </body>
</html>