...
<html>
    <head>
        ...
        <title>Student Manipulate Form</title>
...
<div class="container">
  <div class="row">
    ...
    <form:input type="text" path="firstname" class="form-control" id="fname" />
  </div>
  <div class="form-group">
    <label for="lname">Last Name :</label>
    <form:input type="text" path="lastname" class="form-control" id="lname" />
  </div>
  <div class="form-group">
    <label for="education">Education Field :</label>
    <form:input type="text" path="studingfield" class="form-control" id="education" />
  </div>
  ...
  <button type="submit" value="Save" class="btn btn-default">Submit</button>
      ...
      <div id="section42">         
        ...
        <div><a href="<c:url value='/student/student_manipulate' />">Add student form</a></div>
    </body>
</html>