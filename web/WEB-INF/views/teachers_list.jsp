      ...
      <h1>List Teachers</h1>
        <c:if test="${!empty listTeachers}">
            <table class="table table-striped">
                ...
                <c:forEach items="${listTeachers}" var="teachers">
                    <tr>
                        ...
                        <td><a href="<c:url value='/teachers/remove/${teachers.teacherid}' />" >Delete</a></td>
                        <td><a href="<c:url value='/teachers/teacher_manipulate/${teachers.teacherid}' />" >Edit</a></td>
                    </tr>
                </c:forEach>
            </table>
            <br>
        </c:if>
            <a href="<c:url value='/teachers/teacher_manipulate' />" >Add Teachers Form</a>
      <div id="section3">         
        <h1>Section 3</h1>
        <p>Try to scroll this section and look at the navigation list while scrolling!</p>
      </div>
